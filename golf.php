          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/gambar/golf/golf.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/golf/golf-1.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/golf/golf-2.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/golf/golf-3.jpg" alt="">
              </div>
            </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>GOLF</h2>
              <p>
                Golf adalah permainan luar ruang yang dimainkan secara perorangan atau tim yang berlomba memasukkan bola ke dalam lubang-lubang yang ada di lapangan dengan jumlah pukulan tersedikit mungkin. Bola dipukul dengan menggunakan satu set tongkat pemukul yang disebut klab (stik golf).
              </p>
              <p>
                olahraga ini adalah salah satu dari permainan yang tidak memiliki lapangan permainan yang standar, melainkan dimainkan di padang yang masing-masing memiliki desain unik, dan biasanya terdiri dari 9 atau 18 hole (lubang). Aturan utama dalam golf adalah "memainkan sebuah bola dengan stik golf dari daerah tee (teeing ground) ke dalam lubang dengan satu pukulan atau beberapa pukulan berikutnya sesuai dengan Aturan".
              </p>
              ...
              <ul>
                ...
                <script>
                  function redirectToMap() {
                    window.location.href = 'https://maps.app.goo.gl/cvLTRn1ZVwpcXH8V6';
                  }
                </script>
