          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/gambar/basket/basket.jpeg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/basket/basket-1.jpeg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/basket/basket-2.jpeg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/basket/basket-3.jpeg" alt="">
              </div>
            </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>BASKET</h2>
              <p>
                Bola basket (bahasa Inggris: basketball) adalah olahraga bola berkelompok yang terdiri atas dua tim beranggotakan masing-masing lima orang yang saling bertanding mencetak poin dengan memasukkan bola ke dalam keranjang lawan.              </p>
              <p>
                Bola basket dapat di lapangan terbuka, walaupun pertandingan profesional pada umumnya dilakukan di ruang tertutup. Lapangan pertandingan yang diperlukan juga relatif tidak besar, misal dibandingkan dengan sepak bola. Selain itu, permainan bola basket juga lebih kompetitif karena tempo permainan cenderung lebih cepat jika dibandingkan dengan olahraga bola yang lain, seperti voli dan sepak bola.              </p>
              ...
              <ul>
                ...
                <script>
                  function redirectToMap() {
                    window.location.href = 'https://maps.app.goo.gl/z95SNpjU9vPcD9q16';
                  }
                </script>
