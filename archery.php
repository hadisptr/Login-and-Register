          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/gambar/archery/archery.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/archery/archery-1.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/archery/archery-2.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="assets/img/gambar/archery/archery-3.jpg" alt="">
              </div>
            </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>archery</h2>
              <p>
                Panahan (bahasa Inggris: archery) adalah salah satu olahraga yang dilakukan pemanah dengan cara menembakkan anak panah dengan bantuan busur untuk mencapai target atau sasaran tembak pada jarak yang sudah ditentukan.
              </p>
              <p>
                Berdasarkan pembinaan kondisi fisik, ada komponen-komponen fisik yang lebih spesifik untuk panahan, yaitu daya tahan, kekuatan, kelenturan, dan struktur atau akurasi. Dengan memiliki kekuatan otot dan daya tahan otot yang baik, maka akan memberikan keuntungan besar bagi pemanah untuk tampil di puncaknya. Di samping itu, memanah membutuhkan kekuatan otot tubuh bagian atas dan inti yang menggerakkan kelompok otot utama.
              </p>
              ...
              <ul>
                ...
                <script>
                  function redirectToMap() {
                    window.location.href = 'https://maps.app.goo.gl/BcLZC8rP4QdDpJky9';
                  }
                </script>
